...
#          https://github.com/imfallah/ios-caculator
...
#function==============================================================================
def about():
    messagebox.showinfo(""," GITHUB  :    imfallah")
...
seven = Button(mainFrame,activeforeground="black",activebackground="black", text="7", fg="black", image=sevenimage, bd=0, bg="black", cursor="hand2",
...
eight = Button(mainFrame,activeforeground="black",activebackground="black", text="8", fg="black", image=eightimage, bd=0, bg="black", cursor="hand2",
...
four = Button(mainFrame,activeforeground="black",activebackground="black", text="4", fg="black", image=fourimage, bd=0, bg="black", cursor="hand2",
...
five = Button(mainFrame,activeforeground="black",activebackground="black", text="5", fg="black", image=fiveimage, bd=0, bg="black", cursor="hand2",
...
six = Button(mainFrame,activeforeground="black",activebackground="black", text="6", fg="black", image=siximage, bd=0, bg="black", cursor="hand2",
...
one = Button(mainFrame,activeforeground="black",activebackground="black", text="1", fg="black", image=oneimage,bd=0, bg="black", cursor="hand2",
...
two = Button(mainFrame,activeforeground="black",activebackground="black", text="2", fg="black",image=twoimage, bd=0, bg="black", cursor="hand2",
...
three = Button(mainFrame,activeforeground="black",activebackground="black", text="3", fg="black",image=threeimage, bd=0, bg="black", cursor="hand2",
...
plus = Button(mainFrame,activeforeground="black",activebackground="black", text="+", fg="white",image=plusimage, bd=0, bg="black", cursor="hand2",
